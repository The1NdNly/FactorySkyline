...
bool AFGPipelineHologram::TryUpgrade(const FHitResult& hitResult)
{
	return false;
}
...
AActor* AFGPipelineHologram::GetUpgradedActor() const
{
	return nullptr;
}
...
float AFGPipelineHologram::GetSplineLength()
{
	return 0.0f;
}
