...
bool AFGPipelineAttachmentHologram::IsValidHitResult(const FHitResult& hitResult) const
{
	return false;
}
bool AFGPipelineAttachmentHologram::DoMultiStepPlacement(bool isInputFromARelease)
{
	return false;
}
