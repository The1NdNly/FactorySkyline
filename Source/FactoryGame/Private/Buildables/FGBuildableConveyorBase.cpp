...
void UFGConveyorRemoteCallObject::Server_OnUse_Implementation(class AFGBuildableConveyorBelt* target, class AFGCharacterPlayer* byCharacter, uint32 itemRepID, float itemOffset){ }
bool UFGConveyorRemoteCallObject::Server_OnUse_Validate(class AFGBuildableConveyorBelt* target, class AFGCharacterPlayer* byCharacter, uint32 itemRepID, float itemOffset){ return bool(); }
...
bool UFGConveyorRemoteCallObject::Server_ReportInvalidStateAndRequestConveyorRepReset_Validate(AFGBuildableConveyorBase* target)
{
	return bool();
}
