...
AFGBuildableRoad::AFGBuildableRoad() : Super() {
	this->mConnection0 = CreateDefaultSubobject<UFGRoadConnectionComponent>(TEXT("Connection0")); this->mConnection0->SetupAttachment(this->RootComponent);
	this->mConnection1 = CreateDefaultSubobject<UFGRoadConnectionComponent>(TEXT("Connection1")); this->mConnection1->SetupAttachment(this->RootComponent);
