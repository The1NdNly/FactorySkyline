 ...
 */
UCLASS()
class SML_API UModNetworkHandler : public UObject {
    GENERATED_BODY()
private:
    UPROPERTY()
    TMap<TWeakObjectPtr<class UNetConnection>, UObjectMetadata*> Metadata;
...
public:
     ...
     */
    UObjectMetadata* GetMetadataForConnection(UNetConnection* Connection);
